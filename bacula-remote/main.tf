...
resource "yandex_compute_instance" "vm" {
  name = "${var.guest_name_prefix}-vm1${count.index}"  
  count = 2
  ...
  provisioner "file" {
    source      = "/home/user/terraform/checked-versions/bacula-remote"
    destination = "/home/user/bacula-remote"
  }  
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "chmod +x /home/user/bacula-remote/setupclient.sh",
      "sudo /home/user/bacula-remote/setupclient.sh",
    ]  
  }
}
...
resource "yandex_compute_instance" "makhota-server" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo timedatectl set-timezone Europe/Moscow",
      "chmod +x /home/user/bacula-remote/setupserver.sh",
     # "sudo /home/user/bacula-remote/setupserver.sh",
